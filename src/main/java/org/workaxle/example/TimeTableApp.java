...
import org.workaxle.example.solver.TimeTableConstraintProvider;
...
public class TimeTableApp {
    ...
    public static void main(String[] args) {
        ...
        // load the dataset
        TimeTable dataset = generateDemoData();

        // solve the problem
        Solver<TimeTable> solver = solverFactory.buildSolver();
        TimeTable solution = solver.solve(dataset);
