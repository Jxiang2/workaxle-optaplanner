...
public class BaseConstraintPenalty {
    ...
    static int atMostOneShiftPerDayPenalty(ShiftAssignment first, ShiftAssignment second) {
        return DAY_IN_HOURS;
    }
    ...
    static int noOverlappingShiftsPenalty(ShiftAssignment first, ShiftAssignment second) {
